            ...
            <div class="owl-slider owl-carousel">
                <div class="item" >
                    <div class="owl-slider-item">
                        ...
                        <div class="intro-text" id="intro">
                            <div class="intro-heading">1  <img src="<%=gi.imgarr.get(0)%>"></div>
                ...
                <div class="item">
                    <div class="owl-slider-item">
                        ...
                        <div class="intro-text">
                            <div class="intro-heading">2  <img src="<%=gi.imgarr.get(1)%>"></div>
                ...
                <div class="item">
                    <div class="owl-slider-item">
                        <img src="images/demo/slider-1.jpg" class="img-responsive" alt="portfolio">
                        <div class="intro-text">
                            <div class="intro-heading">3  <img src="<%=gi.imgarr.get(2)%>"></div>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="owl-partners owl-carousel">
                    <%for(int p=0;p<15;p++){ %>
                    <div class="item">
                        <div class="partner-logo"><img src="<%=gi.imgarr.get(p) %>" alt="partners"></div><br><br><br>
