   ...
   <div class="container">
          ...
          <table class="table">
              ...
              <tr style="text-align:left;height:60px; background-color:#fec503;font-size:17px;border-color: #1a1a1a;border:1px">
                  <th style="text-align:left;height:60px; background-color:#5D5D5D;font-size:17px;width:8%;color:white;">RANK</th>
                  <th colspan="2" style="color: #696969">FREE GAME</th>
                  <th colspan="2" style="color: #696969">PAYED GAME</th>
                  <th colspan="2" style="color: #696969">BEST SELLER</th>
              </tr>
              </thead>
              <tr align=center>
                  <%
...
%><tr>
              ...
              <td style="font-size:20px;font-weight: bold; font-style: italic; text-align:center;">
                  <%}%><%=i+1%></td>
              <td><a href="FreeChart.jsp?name=<%=gn.namearr.get(i)%>&img=<%=gi.imgarr.get(i)%>&star=<%=gs.stararr.get(i)%>"><img src="<%=gi.imgarr.get(i)%>"></a></td>
              <td><a href="FreeChart.jsp?name=<%=gn.namearr.get(i)%>&img=<%=gi.imgarr.get(i)%>&star=<%=gs.stararr.get(i)%>" style="color:black;"><%=gn.namearr.get(i) %></a></td>


              <td><a href="FreeChart.jsp?name=<%=gn.namearr.get(i+50)%>&img=<%=gi.imgarr.get(i+50)%>&star=<%=gs.stararr.get(i+50)%>"><img src="<%=gi.imgarr.get(i+50)%>"></a></td>
              <td><a href="FreeChart.jsp?name=<%=gn.namearr.get(i+50)%>&img=<%=gi.imgarr.get(i+50)%>&star=<%=gs.stararr.get(i+50)%>" style="color:black;"><%=gn.namearr.get(i+50) %></a></td>


              <td><a href="FreeChart.jsp?name=<%=gn.namearr.get(i+100)%>&img=<%=gi.imgarr.get(i+100)%>&star=<%=gs.stararr.get(i+100)%>"><img src="<%=gi.imgarr.get(i+100)%>"></a></td>
              <td><a href="FreeChart.jsp?name=<%=gn.namearr.get(i+100)%>&img=<%=gi.imgarr.get(i+100)%>&star=<%=gs.stararr.get(i+100)%>" style="color:black;"><%=gn.namearr.get(i+100) %></a></td>
